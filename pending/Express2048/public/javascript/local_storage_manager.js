...
// Login user getters/setters
LocalStorageManager.prototype.getUserState = function () {
    return this.storage.getItem(this.userStateKey) || 0;
};
LocalStorageManager.prototype.setUserState = function (user) {
    this.storage.setItem(this.userStateKey, user);
};
